  ...
  return (
    <div style={{ background: '#FFFFFF', minHeight: '100vh', fontFamily: baseFont, color: '#0F172A', paddingBottom: 88 }}>
      ...
      <main style={{ maxWidth: 640, margin: '0 auto', padding: '0 20px' }}>
        ...
        {view === 'activities' && <ActivitiesView data={data} setData={setData} displayFont={displayFont} setView={setView} />}
...
// =====================================================================
function ActivitiesView({ data, setData, displayFont, setView }) {
      ...
      {results.map((p, i) => {
        ...
        return (
          <div key={progId} style={{ background: '#FFFFFF', border: '1px solid #E2E8F0', borderLeft: '3px solid ' + (categoryColour[category] || '#8B3A2C'), borderRadius: 14, padding: '14px 16px', marginBottom: 10 }}>
            ...
            {p.url && (
              <a href={p.url} target="_blank" rel="noopener noreferrer" style={{ display: 'inline-flex', alignItems: 'center', gap: 4, color: '#E11D48', fontSize: 12.5, fontWeight: 600, textDecoration: 'none', marginTop: 10 }}>
